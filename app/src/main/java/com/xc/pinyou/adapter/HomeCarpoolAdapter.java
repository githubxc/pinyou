...
public class HomeCarpoolAdapter extends BaseQuickAdapter<Carpool, BaseViewHolder> {

    private Context mContext;

    public HomeCarpoolAdapter(int layoutResId, @Nullable List<Carpool> data, Context context) {
