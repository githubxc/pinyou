package com.xc.pinyou.chat.model;

import android.text.TextUtils;
import android.util.Log;

import com.xc.pinyou.bean.MyUser;
import com.xc.pinyou.chat.model.i.QueryUserListener;
import com.xc.pinyou.chat.model.i.UpdateCacheListener;
            ...
            UserModel.getInstance().queryUserInfo(info.getUserId(), new QueryUserListener() {
                ...
                public void done(MyUser s, BmobException e) {
                    if (e == null) {
                        ...
                        String avatar = s.getUserAvatar().getFileUrl();
